            ...
            switch (document.getElementById('fleetOptions').value) {
              case 'Up to 4 people--2 large bags':
                if(hours >= 23 || hours < 7){
                  ...
                  const finalPrice = (((Price/100)*40) + Price) + '£';
              ...
              case 'Up to 6 people--3 large bags':
                if(hours >= 23 || hours < 7){
                  const Price = Math.round(miles * 2.5);
                  const finalPrice = (((Price/100)*40) + Price) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                }
                else{
                  const finalPrice = Math.round((miles * 2.5)) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                }
                break;
              ...
              case 'Up to 8 people--4 large bags':
                if(hours >= 23 || hours < 7){
                  const Price = Math.round(miles * 3.5);
                  const finalPrice = (((Price/100)*40) + Price) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                }
                else{
                  const finalPrice = Math.round((miles * 3.5)) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                }
                break;

                case 'Up to 4 people--2 large bags Wheelchair':
                if(hours >= 23 || hours < 7){
                  const Price = Math.round(miles * 2);
                  const finalPrice = ((((Price/100)*40) + Price) * 2) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                }
                else{
                  const finalPrice = Math.round((miles * 2)*2) + '£'
                  document.getElementById('confirmed-price').textContent = finalPrice;
                }
                break;
            
              case 'Up to 6 people--3 large bags Wheelchair':
                if(hours >= 23 || hours < 7){
                  const Price = Math.round(miles * 2.5);
                  const finalPrice = ((((Price/100)*40) + Price) * 2) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                  ...
                  const finalPrice = Math.round((miles * 2.5)*2) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                }
                break;
            
              case 'Up to 8 people--4 large bags Wheelchair':
                if(hours >= 23 || hours < 7){
                  const Price = Math.round(miles * 3.5);
                  const finalPrice = ((((Price/100)*40) + Price) * 2) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                  ...
                  const finalPrice = Math.round((miles * 3.5)*2) + '£';
                  document.getElementById('confirmed-price').textContent = finalPrice;
                }
                break;
